...
- Send acknowledgement to end user that ticket has been received (no troubleshooting)
- Change status to "Plan Rew - Waiting review"
...
TICKET AWKNOWLEDGEMENT:
- Tone should be professional & polite 
- Never provide troubleshooting steps 
- Do not infer or provide timelines 
- Simply Acknowledge that the request has been received and is being processed
...
# Final Step: After all other processing has finished and actions completed, set the ticket Status to "Plan Req - Waiting Review". @𝘈𝘥𝘥 𝘐𝘯𝘵𝘦𝘳𝘯𝘢𝘭 𝘛𝘪𝘤𝘬𝘦𝘵 𝘕𝘰𝘵𝘦 using the following format: 
```
#==========================
